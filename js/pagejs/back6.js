...
function member_edit(obj, id) {
  ...
  var wd = `<option value="">请选择保护器类型</option> <option value="有源表带式B">有源表带式B</option> <option value="无源表带式G">无源表带式G</option> <option value="红外式H">红外式H</option><option value="微型W">微型W</option><option value="磁吸附式C">磁吸附式C</option><option value="RFID射频R">RFID射频R</option>`;
